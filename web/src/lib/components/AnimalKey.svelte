...
{#if layout === 'compact'}
  <div class="flex flex-wrap gap-2">
    {#each ANIMALS as a}
      <div class="flex items-center gap-1.5 rounded-md border border-gray-200 bg-gray-50 px-2 py-1 dark:border-white/10 dark:bg-white/5"
...
{:else}
  <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
    {#each ANIMALS as a}
      <div class="flex items-center gap-2 rounded-md border border-gray-200 bg-gray-50 p-2 dark:border-white/10 dark:bg-white/5"
        class:opacity-30={!isOn(a.index)}>
        ...
        <div class="flex flex-col leading-tight">
          <span class="text-xs">
            ...
            <span class="font-mono text-gray-700 dark:text-gray-300">{a.homeLetter}</span>
          </span>
          <span class="text-xs text-gray-700 dark:text-gray-300">{a.name}</span>
        </div>
